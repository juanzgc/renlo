...
export function attachSubscriber<
  T extends Constructor<EntitySubscriberInterface<unknown>>
>(Subscriber: T, transactionalEntityManager?: EntityManager): void {
  const subscriberIndex = dataSource.subscribers.findIndex(
    (subsciber: EntitySubscriberInterface) => {
