...
export class initialMigration1669991329184 implements MigrationInterface {
    name = 'initialMigration1669991329184'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "line_item" DROP COLUMN "order_edit_id"`);
        await queryRunner.query(`ALTER TABLE "line_item" DROP COLUMN "original_item_id"`);
        await queryRunner.query(`ALTER TABLE "line_item" DROP COLUMN "includes_tax"`);
        await queryRunner.query(`ALTER TABLE "payment_session" DROP COLUMN "payment_authorized_at"`);
        await queryRunner.query(`ALTER TABLE "payment_session" DROP COLUMN "amount"`);
        await queryRunner.query(`ALTER TABLE "cart" DROP COLUMN "sales_channel_id"`);
        await queryRunner.query(`ALTER TABLE "refund" DROP COLUMN "payment_id"`);
        await queryRunner.query(`ALTER TABLE "order" DROP COLUMN "sales_channel_id"`);
        await queryRunner.query(`ALTER TABLE "price_list" DROP COLUMN "includes_tax"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "region" ADD "includes_tax" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "price_list" ADD "includes_tax" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "order" ADD "sales_channel_id" character varying`);
        await queryRunner.query(`ALTER TABLE "refund" ADD "payment_id" character varying`);
        await queryRunner.query(`ALTER TABLE "cart" ADD "sales_channel_id" character varying`);
        await queryRunner.query(`ALTER TABLE "payment_session" ADD "amount" integer`);
        await queryRunner.query(`ALTER TABLE "payment_session" ADD "payment_authorized_at" TIMESTAMP WITH TIME ZONE`);
        await queryRunner.query(`ALTER TABLE "line_item" ADD "includes_tax" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "line_item" ADD "original_item_id" character varying`);
        await queryRunner.query(`ALTER TABLE "line_item" ADD "order_edit_id" character varying`);
        await queryRunner.query(`ALTER TABLE "shipping_method" ADD "includes_tax" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "shipping_option" ADD "includes_tax" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "currency" ADD "includes_tax" boolean NOT NULL DEFAULT false`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "unique_li_original_item_id_order_edit_id" ON "line_item" ("original_item_id", "order_edit_id") WHERE ((original_item_id IS NOT NULL) AND (order_edit_id IS NOT NULL))`);
